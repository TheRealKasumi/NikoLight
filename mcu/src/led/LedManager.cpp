	...
	for (size_t i = 0; i < TL::LedManager::ledAnimator.size(); i++)
	{
		...
		else if (ledConfig.type == 1)
		{
			TL::LedManager::ledAnimator.at(i).reset(new TL::SparkleAnimator(
				...
				ledConfig.animationSettings[8] / 10240.0f,
				ledConfig.animationSettings[9] / 5120.0f,
				...
				ledConfig.animationSettings[15] / 10240.0f,
				ledConfig.animationSettings[16] / 5120.0f,
