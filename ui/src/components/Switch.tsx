    ...
    >
      <SwitchPrimitive.Thumb
        className={classNames(
          ...
          'pointer-events-none inline-block h-[20px] w-[20px] transform rounded-full bg-neutral shadow-lg ring-0 transition duration-200 ease-in-out',
        )}
      />
    </SwitchPrimitive.Root>
  );
